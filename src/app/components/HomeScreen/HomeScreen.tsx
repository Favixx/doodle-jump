...
import ShopModal from '@/app/ShopModal/ShopModal';
...
const HomeScreen = () => {
  ...
  const [showShopModal, setShowShopModal] = useState(false); // Состояние для отображения модального окна
    ...
    <ScreenContainer>
      ...
      <ContentContainerColumn>
        ...
        <ButtonsContainer>
          ...
          <ButtonContainer>
            <ButtonSmall onClick={() => setShowShopModal(true)}>
              Shop
            </ButtonSmall>
